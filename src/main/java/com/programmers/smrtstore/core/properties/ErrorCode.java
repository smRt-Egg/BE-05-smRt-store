...
public enum ErrorCode {
    ...
    INAPPROPRIATE_AGE(BAD_REQUEST, "나이는 7~200살이어야 합니다."),
    INAPPROPRIATE_NICKNAME_LENGTH(BAD_REQUEST, "별명은 1~10자여야 합니다."),
    INAPPROPRIATE_EMAIL_FORM(BAD_REQUEST, "이메일이 형식에 맞지 않습니다."),
    INAPPROPRIATE_BIRTH_FORM(BAD_REQUEST, "생년월일이 형식에 맞지 않습니다."),
    INAPPROPRIATE_PHONE_NUM_FORM(BAD_REQUEST, "전화번호가 형식에 맞지 않습니다."),
    INAPPROPRIATE_SHIPPING_ADDRESS_NAME_LENGTH(BAD_REQUEST, "배송지 이름은 1~10자여야 합니다."),
    INAPPROPRIATE_RECIPIENT_LENGTH(BAD_REQUEST, "수령인 이름은 1~10자여야 합니다."),
    INAPPROPRIATE_ADDRESS_1_DEPTH_LENGTH(BAD_REQUEST, "주소의 길이는 1~50자여야 합니다."),
    INAPPROPRIATE_ADDRESS_2_DEPTH_LENGTH(BAD_REQUEST, "상세 주소의 길이는 1~30자여야 합니다."),
    // 401
